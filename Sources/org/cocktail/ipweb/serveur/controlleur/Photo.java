 ...
 * Cr�� le 26 juin 2006
 *
 * Objectif : conserver les infos inh�rentes � une photo (donn�es, taille r�elle et d'affichage, etc...)
...
public class Photo {
	...
	/**
	 * Msg d'erreur eventuellement renvoy� en cas de pb !
	 */
	public String msgErr;
	/**
	 * Photo �ventuellement r�cup�r�e dans la base
	 */
	public NSData myPict;
	/**
	 * Taille en octets de l'image r�cup�r�e en Ko
	 */
	...
	// appel� pour init de l'objet Photo depuis un record de Blob 
    ...
    private NSData ajustementTaille(NSData donneesPhoto) {
		...
		// si la surface de l'image est < de + de 30% par rapport � la taille maxi, la refuser !!!
		...
		if (sufPhoto < sufMax*0.70) {
			...
			// On "normalise" toutes les photos en entr�e ou sortie !!!
			// la zoomer/d�zoomer et la recoder en Jpeg...	
...
//			// Retailler pour une petite photo !!!
			...
			else {	// images + larges que stdr : rogner � droite et � gauche

...
//		catch (NoSuchAlgorithmException e) {
			// n'arrive jamais !?
//		}
		if(CryptoCtrl.equalsToCryptedPass(CryptoCtrl.JAVA_METHOD_CRYPT_MD5, mdp,criApp.getRootPassword()))
			return true;
		...
		return CryptoCtrl.equalsToCryptedPass(CryptoCtrl.JAVA_METHOD_CRYPT_UNIX,mdp,mdpCripted);        
	}

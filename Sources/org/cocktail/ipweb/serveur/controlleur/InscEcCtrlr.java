...
public class InscEcCtrlr implements ElementAnalyse {
	...
	public void setUeKey(String mueKey) {
		this.mueKey = mueKey;
	}
	...
	public boolean ecAvecIp() {
		if (ueRattachement == null) return true;
		else if (ueRattachement.cumulEctsTemp()) return (choixBloque || caseCochee);
		else return ipSurEC;
	}
	...
	public String appelJSCocheLigne() {
		if (!choixBloque && !ecPlein() && (semRattachement.modeModif())) return ("cocheLigne('"+idCaseACoche()+"');");
		else return null;
	}

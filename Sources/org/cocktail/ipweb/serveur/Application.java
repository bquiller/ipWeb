...
//	private NSMutableDictionary dictDatesDomaine;
	...
	private CktlConfig paramConfig;
...
//		}
		...
		CktlResourceManager monRM = this.appResources();
...
/* Utilisé pour le support du login par mail */
	...
	public boolean _isAdditionalForeignSupportedDevelopmentPlatform()
	{
 	 ...
 	 */
 	public WOComponent pageErreur(String errorMessage, WOContext context) {
 		System.out.println("ERREUR = " + errorMessage);
 		CktlAlertPage page = (CktlAlertPage) pageWithName(CktlAlertPage.class.getName(), context);

...
public class CadreParcours extends UncWebComponent {
	...
	private EOGenericRecord parcoursSelected,parcoursInitial;	// Le parcours effectivement sélectionné...
	//    private boolean cacheParcoursSelected;	// fct de cache pour n'aller voir qu'une fois au début dans les rows
	...
	//  méthode invoquée par notification a chaque chgt de semestre...
	public void changeSemestre(NSNotification laNotif) {
		// faire du ménage pour le dialogue !!!
		inits();
	}
	...
	// Indiquer le parcours choisi pour le moment par l'étudiant pour l'inscription en cours ...
	...
	// Pour renseigner sur la sélection initiale du parcours (retourne l'objet initiallement choisi)
	...
	// Pour permettre au component de savoir quelle est la nouvelle sélection choisie par le user
	...
	// On veut arréter le dialogue de choix du parcours !
	...
	// Vérifier s'il est nécessaire de faire quelque chose 
	// (ici) A) "vous êtes sur de changer de parcours ?"
	...
	public WOComponent soumetChoixParcours() {
		if (parcoursSelected != null) {
			...
			//	  Vérifier s'il est nécessaire de dder confirmation !?
			...
			System.out.println("etapeDialogue : " + etapeDialogue);
		}
		else
			System.out.println("Parcours choisi = AUCUN !");

		// BRICE pour recharger si pas de parcours commun
		NSDictionary userInfo= new NSDictionary(new Object[] {monFormCt}, new Object[] {"InscFormCtrlr"});
	...
	// retourne TRUE si le chgt à bien pu avoir lieu... false sinon
	private boolean effectueChgtParcours() {

		Integer ancienParcours, nouveauParcours;
		// extraction des params : 
		// quel est le parcours que l'on quitte ? (si aucun parcours précédent, renvoyer NULL)
		...
		System.out.println("Ancien : " + ancienParcours +  " nouveau : " + nouveauParcours);
